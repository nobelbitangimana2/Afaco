...
const HERO_SLIDES = [
  { imageUrl: 'https://images.unsplash.com/photo-1500382017468-9049fed747ef?w=1400&q=80', imageAlt: 'Green farmland at sunrise' },
  { imageUrl: 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=1400&q=80', imageAlt: 'Farmer working in the field' },
  { imageUrl: 'https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=1400&q=80', imageAlt: 'Maize crop harvest season' },
  { imageUrl: 'https://images.unsplash.com/photo-1594736797933-d0501ba2fe65?w=1400&q=80', imageAlt: 'Women farmers at work' },
]
...
export default function Home() {
  ...
  return (
    <div className="home">
      ...
      {/* ── Mission & Vision ── */}
      <Section label="Who we are" title="Our Mission &amp; Vision" tinted id="mission">
      ...
      <section className="home__cta-banner" aria-label="Call to action">
        <div className="container home__cta-inner">
          <div>
            ...
            <p className="home__cta-sub">Partner with AFACO or support a farmer today.</p>
          </div>
